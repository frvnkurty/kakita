...
for($i=0;$i <= 800; $i++){
    $pos_x = redondear2(rand(0,5000));
    $pos_y = redondear2(rand(0,5000));
    ...
    $entrada = array("+bomba", "+veneno");
    $claves_aleatorias = $entrada[rand(0,0)];
    ...
    echo '<span style="left:'.$pos_x.';top:'.$pos_y.';background-color:black!important;" title="'.$claves_aleatorias.'"></span>';
...
for($i=0;$i <= 400; $i++){
    ...
    $entrada = array("+weed", "+tussy", "+cocaine", "+weed", "+vinito", "+weed", "+vinito");
    $claves_aleatorias = $entrada[rand(0,6)];
